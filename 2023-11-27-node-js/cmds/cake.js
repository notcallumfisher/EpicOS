...
let info = {
	...
	wip: false,
	rank: 1,
	description: "...We are throwing a party in honor of your tremendous success."
}
...
async function run (args) {
	...
	qMsg(Z.generate("the cake is a LiE the CAKE is a LIE the cake is a lie."));
	stop();
}
