...
async function run (args) {
	...
	let BGM = await runEval("playBackgroundMusic");
	BGM = !BGM;
	await runEval("playBackgroundMusic = !playBackgroundMusic");
	sendChat(`${BGM ? "Enabled" : "Disabled"} background music.`);
	stop();
}
