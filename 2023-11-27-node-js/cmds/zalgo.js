...
let info = {
	...
	wip: false,
	rank: 1,
	description: "Converts your input!"
}
...
async function run (args) {
	...
	if (input) {
		sendChat(Z.generate(input));
	} else {
		sendChat(`Please input something for me to convert. (Usage: ${info.usage.replace(/%cmdprefix%/g, cmdPrefix)})`);
	}
	stop();
}
